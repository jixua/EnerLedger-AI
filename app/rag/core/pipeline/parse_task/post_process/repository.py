...
from app.rag.models.parse_task import DocumentParsedLog, DocumentParsePipeline
...
class ParsePipelineRepository:
    ...
    async def mark_cleaning_started(
        ...
        *,
        ...
        await self._mark_started(
            db, pipeline, stage=POST_PROCESS_STAGE_CLEANING, started_at=started_at
        )
    ...
    async def mark_chunking_started(
        ...
        *,
        ...
        """开始分片阶段。"""
        await self._mark_started(
            db, pipeline, stage=POST_PROCESS_STAGE_CHUNKING, started_at=started_at
        )
    ...
    async def mark_vectorizing_started(
        ...
        *,
        ...
        """开始 dense 向量化阶段。"""
        await self._mark_started(
            db, pipeline, stage=POST_PROCESS_STAGE_VECTORIZING, started_at=started_at
        )
    ...
    async def mark_pretokenize_started(
        ...
        *,
        ...
        """开始预分词阶段。"""
        await self._mark_started(
            db, pipeline, stage=POST_PROCESS_STAGE_PRETOKENIZE, started_at=started_at
        )
    ...
    async def mark_es_indexing_started(
        ...
        *,
        ...
        """开始 ES 入库阶段。"""
        await self._mark_started(
            db, pipeline, stage=POST_PROCESS_STAGE_ES_INDEXING, started_at=started_at
        )
