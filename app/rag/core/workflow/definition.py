...
from app.rag.core.workflow._utils import topo_sort
from app.rag.core.workflow.constants import ValidationErrorCode
from app.rag.core.workflow.exceptions import WorkflowValidationError
...
class WorkflowDefinition:
    ...
    def edges(self) -> set[tuple[str, str]]:
        return {
            (source, target) for source, targets in self._adjacency().items() for target in targets
        }
