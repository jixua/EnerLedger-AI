...
if TYPE_CHECKING:
    from app.rag.core.dataset_config import ChunkingConfig

from loguru import logger

from app.rag.config import settings
from app.rag.core.llm.interfaces import CapabilityType, IEmbedder
...
# DashScope 各文本向量模型单次 /embeddings 请求的 input 条数上限。
# 参考：https://www.alibabacloud.com/help/en/model-studio/text-embedding-synchronous-api
# text-embedding-v1~v4 为 10；qwen3.7-text-embedding 为 20。
