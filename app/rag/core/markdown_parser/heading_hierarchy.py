    ...
    *,
    ...
    for insertion in plan.insertions:
        ...
        if insertion.line not in allowed_insertion_lines:
            raise HeadingPlanValidationError(
                f"heading insertion line is not a parser-confirmed candidate: {insertion.line}"
            )
...
def _report_heading_usage(
    *,
    ...
    if usage is None:
        return
    from app.rag.core.markdown_parser.provider_clients import _report_enhancement_usage
