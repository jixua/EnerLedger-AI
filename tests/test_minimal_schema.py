...
def test_alembic_has_single_minimal_revision_chain() -> None:
    ...
    document_filename_unique_revision = runpy.run_path(str(version_files[6]))
    ...
    assert document_filename_unique_revision["revision"] == "0007_document_filename_unique"
    assert document_filename_unique_revision["down_revision"] == "0006_document_dispatch_outbox"
